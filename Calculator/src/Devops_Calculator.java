...
public class Devops_Calculator extends Frame {
	...
	Devops_Calculator(String frameText)  {  
		super(frameText);  
...
//set Co-ordinates for Special Buttons  
		...
		{  
		new Devops_Calculator("Calculator - JavaTpoint");  
		}  
		}  
		...
		MyOperatorButton(int x,int y, int width,int height,String cap, Devops_Calculator clc)  
		{  
		super(cap);  
		setBounds(x,y,width,height);  
		this.cl=clc;  
		...
		if(opText.equals("1/x"))  
		    ...
		    try  
		        ...
		        cl.displayLabel.setText(Devops_Calculator.getFormattedText(tempd));}  
		...
		cl.displayLabel.setText(Devops_Calculator.getFormattedText(temp));  
		//cl.number=temp;  
		}//actionPerformed  
		}//class  
		...
		/////////////////////////////////  
		MyMemoryButton(int x,int y, int width,int height,String cap, Devops_Calculator clc)  
		{  
		super(cap);  
		setBounds(x,y,width,height);  
		this.cl=clc;  
		...
		case 'R':   
		    cl.displayLabel.setText(Devops_Calculator.getFormattedText(cl.memValue));break;  
		case 'S':  
		    cl.memValue=0.0;  
		case '+':   
		...
		MySpecialButton(int x,int y, int width,int height,String cap, Devops_Calculator clc)  
		{  
		super(cap);  
		setBounds(x,y,width,height);  
		this.cl=clc;  
